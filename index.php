            ...
            <div class="collapse navbar-collapse row" id="navbarNav">
                <ul class="navbar-nav navfull">
                    <li class="nav-item row navfull">
                        <a class="btn btn-primary navbtn navbtnperso" href="#">
            ...
            <div class="tab-content">
              <div id="void" class="container tab-pane">
                ...
                <div id="menu1" class="container tab-pane fade">
                    <br>
                    <h1>La gourvernance</h1>
                    <p> - Le comité stratégique
                        <br>
                        <br> - Le comité médical
                        <br>
                        <br> - Comité territorial des élus locaux
                        <br>
                        <br> - Conférence territoriale de dialogue social
                        <br>
