            ...
            <div class="collapse navbar-collapse row" id="navbarNav">
                <ul class="navbar-nav navfull">
                    <li class="nav-item row navfull">
                        <a class="btn btn-primary navbtn navbtnperso" href="http://www.chiva-chpo.fr/">
                            <div class=flexRow trait"><img src="img/logo_chiva.jpg" class="logo_min">
                                <p class="navTypo ">&nbsp; CHIVA</p>
                            </div>
                            <span class="sr-only"></span>
                        </a>
                        <a class="btn btn-primary navbtn navbtnperso" href="http://www.ch-ariege-couserans.fr/">
                            <div class="flexRow trait">
                                <img src="img/logo_chac.png" class="logo_min">
                                <p class="navTypo">&nbsp; CHAC</p>
                            </div>
                            <span class="sr-only"></span>
                        </a>
                        <a class="btn btn-primary navbtn navbtnperso" href="http://www.hopital-tarascon09.com/">
                            <div class="flexRow trait"><img src="img/logo_tarascon.png" class="logo_min">
                                <p class="navTypo">&nbsp; Jules Rousse</p>
                            </div>
                            <span class="sr-only"></span>
                        </a>
                        <a class="btn btn-primary navbtn navbtnperso" href="http://www.ch-axlesthermes.fr/">
                            <div class="flexRow"><img src="img/logo_ax.png" class="logo_min">
                                <p class="navTypo">&nbsp; St Louis</p>
                            </div>
                            <span class="sr-only"></span>
                        </a>
                    </li>
...
<div class="container-fluid nomarges visibleOnDesc">
        <div class="container-fluid wildWidth nomarges pose">
            <br>
            <!-- Nav pills -->
            <ul class="nav nav-pills mx-auto wildWidth" role="tablist">
                <li class="nav-item nav3">
                    <a class="nav-link" data-toggle="pill" href="#void"><i class="fas fa-minus-square"></i></a>
                </li>
                <li class="nav-item nav2">
                    <a class="nav-link" data-toggle="pill" href="#home">Mieux nous connaître</a>
                </li>
                <li class="nav-item nav2">
                    <a class="nav-link" data-toggle="pill" href="#menu1">La gourvernance</a>
                </li>
                <li class="nav-item nav2">
                    <a class="nav-link" data-toggle="pill" href="#menu2">Les projets</a>
                </li>
                <li class="nav-item nav2">
                    <a class="nav-link" data-toggle="pill" href="#menu3">Quelques chiffres clés</a>
                </li>
            </ul>
            <!-- Tab panes -->
            <div class="tab-content">
              <div id="void" class="container tab-pane">
                </div>
                <div id="home" class="container tab-pane">
                    <br>
                    <h1>Présentation</h1>
                    <p>Les quatre établissements de santé publics du département de l’Ariège constituent désormais le groupement hospitalier de territoire des Pyrénées Ariégeoises, dispositif issue de la loi de modernisation du système de santé du 26 janvier 2016 visant à une meilleure prise en charge des patients.
                        <br> Le GHT couvre le bassin de population départementale de 155 000 habitants.
                        <br>
                        <br> L’objectif de ce groupement est de garantir à la population ariégeoise l’accès à une offre de soins de proximité, d’améliorer la prise en charge des patients en offrant une meilleure complémentarité des établissements membres et d’organiser une plus grande structuration des parcours de patients.
                        <br>
                        <br> Le groupement est composé de 4 établissements de santé:
                        <br> - Le Centre hospitalier des vallées de l’Ariège
                        <br> - Le Centre hospitalier Ariège Couserans
                        <br> - Le Centre hospitalier de Tarascon
                        <br> - Le Centre hospitalier d’Ax-les-Thermes
                        <br>
                        <br> La convention constitutive du Groupement Hospitalier de Territoire des Pyrénées Ariégeoises, établie par le Comité Stratégique a été signée le 22 juin 2016.
                        <br>
                        <br> Le CHIVA a été désigné par l’ARS comme établissement support de ce groupement.
                        <br>
                        <br> La mise en place d’un projet médico-soignant commun, de structures et d’organisation collaboratives dans des domaines variés (achats, formation du personnel, système d’information…) vont faire vivre cette structure. Le projet médico-soignant partagé, élaboré par les médecins, directeurs, directeurs des soins des hôpitaux), repose sur un socle visant à :
                        <br>
                        <br> - Assurer une prise en charge de proximité des patients en s’appuyant sur les compétences particulières de chaque établissement, Promouvoir collectivement l’ambition de service public sur le territoire de l’Ariège
                        <br>
                        <br> - S’inscrire dans un travail approfondi d’harmonisation des filières territoriales, pour prendre en charge les patients au plus près de leur domicile dans le cadre d’une graduation équilibrée entre les sites hospitaliers,
                        <br>
...
<div id="gouvernance" data-spy="scroll" data-target=".navbar" data-offset="50">

<nav class="navbar navbar-expand-lg bg-dark navbar-dark">  
  <ul class="navbar-nav">
    <li class="nav-item">
      <a class="nav-link" href="#section1">Le comité stratégique</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="#section2">Le comité médical</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="#section3">Comité territorial des élus locaux</a>
    </li>
    <li class="nav-item ">
      <a class="nav-link " 
href="#section4">Conférence territoriale de dialogue social</a>
    </li>
    <li class="nav-item ">
...
<div id="section1" class="container-fluid" style="padding-top:100px;padding-bottom:70px">
  <h1>Le comité stratégique</h1>
  <p>Lorem ipsum dolor sit amet, at vix falli utamur bonorum, simul perpetua vix ei, habemus tractatos honestatis vis ei. At solet affert cotidieque vis. Usu ei partem scribentur, sea dicta fabellas laboramus cu. An sed imperdiet disputationi, vis dictas eligendi cu, hinc noster bonorum no pri. Id ignota ceteros dolores his, per alia facilis ex, vim an commodo accusamus.</p>
</div>
<div id="section2" class="container-fluid" style="padding-top:70px;padding-bottom:70px">
  <h1>Le comité médical</h1>
  <p>Lorem ipsum dolor sit amet, at vix falli utamur bonorum, simul perpetua vix ei, habemus tractatos honestatis vis ei. At solet affert cotidieque vis. Usu ei partem scribentur, sea dicta fabellas laboramus cu. An sed imperdiet disputationi, vis dictas eligendi cu, hinc noster bonorum no pri. Id ignota ceteros dolores his, per alia facilis ex, vim an commodo accusamus.</p>
</div>
<div id="section3" class="container-fluid" style="padding-top:70px;padding-bottom:70px">
  <h1>Comité Territorial des Elus locaux</h1>
  <p>Lorem ipsum dolor sit amet, at vix falli utamur bonorum, simul perpetua vix ei, habemus tractatos honestatis vis ei. At solet affert cotidieque vis. Usu ei partem scribentur, sea dicta fabellas laboramus cu. An sed imperdiet disputationi, vis dictas eligendi cu, hinc noster bonorum no pri. Id ignota ceteros dolores his, per alia facilis ex, vim an commodo accusamus.</p>
</div>
<div id="section4" class="container-fluid " style="padding-top:70px;padding-bottom:70px">
  <h1>Conférence Territoriale du dialogue social</h1>
  <p>Lorem ipsum dolor sit amet, at vix falli utamur bonorum, simul perpetua vix ei, habemus tractatos honestatis vis ei. At solet affert cotidieque vis. Usu ei partem scribentur, sea dicta fabellas laboramus cu. An sed imperdiet disputationi, vis dictas eligendi cu, hinc noster bonorum no pri. Id ignota ceteros dolores his, per alia facilis ex, vim an commodo accusamus.</p>
</div>
<div id="section5" class="container-fluid " style="padding-top:70px;padding-bottom:70px">
  <h1>La commission des soins</h1>
  <p>Lorem ipsum dolor sit amet, at vix falli utamur bonorum, simul perpetua vix ei, habemus tractatos honestatis vis ei. At solet affert cotidieque vis. Usu ei partem scribentur, sea dicta fabellas laboramus cu. An sed imperdiet disputationi, vis dictas eligendi cu, hinc noster bonorum no pri. Id ignota ceteros dolores his, per alia facilis ex, vim an commodo accusamus.</p>
</div>
<div id="section6" class="container-fluid " style="padding-top:70px;padding-bottom:70px">
  <h1>La commission des élus </h1>
  <p>Lorem ipsum dolor sit amet, at vix falli utamur bonorum, simul perpetua vix ei, habemus tractatos honestatis vis ei. At solet affert cotidieque vis. Usu ei partem scribentur, sea dicta fabellas laboramus cu. An sed imperdiet disputationi, vis dictas eligendi cu, hinc noster bonorum no pri. Id ignota ceteros dolores his, per alia facilis ex, vim an commodo accusamus.</p>
</div>
                </div>
            </div>
                ...
                <div id="menu3" class="container tab-pane fade">
                    <div class="row">
                    <div id="texte" class="col-sm-6">
                    <br>
                    <h1>Quelques chiffres</h1>
                    <br>
                    <p>NB HÔPITAUX : 4</p>
                    <p>BUDGET : 12876</p>
                    <p>NB DE LITS DISPONIBLES : 648</p>                
                    <p>NB DE PERSONNES : 288</p>
                    <p>NB DE CONSULTATIONS : 15000 </p>
                    </div>
                <br>
                <div id="graphique" class="col-sm-6"> <img src="img/graphique.png" style="width: 100%"></div>
            </div>
            </div>
        </div>
          ...
          <div id="demo" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <div class="carouin">
                      <div class="col-4">
                        <img src="img/chiva.jpg" class="wildWidth" alt="Chiva">
                      </div>
                    <div class=" col-6 caroutxt">
                      <h4>Centre Hospitalier Ariège Couserans</h4>
                        <p>dslkjfdsjfksjdlksqj</p>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora, est illo pariatur laudantium quod eius eum ducimus adipisci voluptas ratione impedit quisquam tenetur nisi, assumenda, possimus sapiente dolores harum velit.
                    </div>
                ...
                <div class="carousel-item">
                  <div class="carouin">
                    <div class="col-4">
                    <img class="wildWidth" src="img/chac.jpg" alt="Chac">
                  </div>
                ...
                <div class="carousel-item">
                  <div class="carouin">
                    <div class="col-4">
                    <img class="wildWidth" src="img/jules.jpg" alt="Jules Rousse">
                  </div>
                    <div class="caroutxt">
                      <h4>Centre Hospitalier Ariège Couserans</h4>
                        <p>dslkjfdsjfksjdlksqj</p>
                    ...
                    <div class="carousel-item">
                      <div class="carouin">
                        <div class="col-4">
                    <img class="wildWidth" src="img/louis.jpg " alt="saint Louis">
                  </div>
                    <div class="caroutxt">
                      <h4>Centre Hospitalier Ariège Couserans</h4>
                        <p>dslkjfdsjfksjdlksqj</p>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">
                        <button type="button" class="btn btn-link"> Petite présentation
                        </button>
                    </a>
                </div>
            </div>
        ...
        <div class="row">
                    ...
                    <div class="mx-auto">
                        <button type="button" class="btn boutonRond" data-toggle="modal" data-target="#emploi">
                            <div class="boutonMarche">
                                ...
                                <!-- <img src="https://image.flaticon.com/icons/png/512/510/510943.png" class="media-object" style="width:50px"> -->
                            </div>
                            <br>
                        </button>
                    </div>
                    <p class="mx-auto text-center"> Offres d'emploi </p>
                    <div class="modal fade" id="emploi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col">
                                                <a href="http://www.chiva-chpo.fr/accueil-chiva/1-mieux-nous-connaitre/travailler-au-chiva/les-offres-d-emploi.html" class="mx-auto">
                                                    <input class="btn btn-primary wildWidth" name="Chiva " value="CHIVA" type="button">
                                                </a>
                                                <hr>
                                                <a href="http://www.ch-ariege-couserans.fr/ABC/Le-CHAC-recrute/Offres-medicales.aspx" class="mx-auto">
                                                    <input class="btn btn-primary wildWidth" name="Chac" value="CHAC" type="button">
                                                </a>
                                            </div>
                                            <div class="col">
                                                <a href="http://www.ch-axlesthermes.fr/PBCPPlayer.asp?ID=1324701">
                                                    <input class="btn btn-primary wildWidth" name="Ax" value="AX" type="button">
                                                </a>
                                                <hr>
                                                <a href="http://www.hopital-tarascon09.com/PBCPPlayer.asp?ID=532483">
                                                    <input class="btn btn-primary wildWidth" name="Tarascon" value="TARASCON" type="button">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <button type="button" id="boutton" class="btn btn-primary boutonModal mx-auto" data-dismiss="modal">Retour</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div id="droits" class="media">
                    <div class="mx-auto text-center">
                        <button type="button" class="btn boutonRond" data-toggle="modal" data-target="#myModal3">
                            <div class="boutonMarche">
                                <i class="fas fa-check"></i>
                            </div>
                            <br>
                        </button>
                        <p class="mx-auto text-center">Droits du patient</p>
                        <div class="modal fade" id="myModal3" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">Droits du Patient</h4>
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    </div>
                                    <div class="modal-body">
                                        <p>Rendez vous sur le site pour connaître les droits et engagements du patient</p>
                                        <a href="http://www.chiva-chpo.fr/accueil-chiva-2/droits-de-l-usager.html" target="_blank">"http://www.chiva-chpo.fr/accueil-chiva-2/droits-de-l-usager.html"</a>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-primary" data-dismiss="modal">Fermer</button>
                                    </div>
            ...
            <div id="osa" class="col-lg-4">
                <div class="container">
                    ...
                    <div class="tab-content">
                        <div id="1menu1" class="container tab-pane active">
                            <div id="accordion1">
                                <div class="card noBorder">
                                    <div class="card noBorder">
                                        <div class="card-header noBorder" id="headingOne">
                                            <h5 class="mb-0">
        <button class="btn btn-link wildWidth" data-toggle="collapse" data-target="#collapseOne"  aria-expanded="false" aria-controls="collapseOne">
           <li id="cancerologie" class="list-group-item tiles">
          <div class="rondBlanc text-center"> <i class="fas fa-heartbeat pictoParent"></i> </div><div class="pad">&nbsp; Cancerologie</div>
         </li>
        </button>
      </h5>
</div>
           ...
           <!-- ///////////////////////////////////////////////////////////////////////////// -->
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="headingTwo">
                                                <h5 class="mb-0">
 <!--        <button class="btn btn-link wildWidth collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          <li id="chirurgie" class="list-group-item tiles">
          <div class="fas fa-heartbeat pictoParent"></div>&nbsp; Chirurgie</li>
        </button> -->
        <button class="btn btn-link wildWidth" data-toggle="collapse" data-target="#collapseTwo"  aria-expanded="false" aria-controls="collapseTwo">
           <li id="chirurgie" class="list-group-item tiles">
          <div class="rondBlanc text-center"> <embed type="image/svg+xml" class=" pictoParent" src="img/surgeon-icon.svg"> </div><div class="pad">&nbsp; Chirurgie</div>
         </li>
        </button>
      </h5>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="headingThree">
                                                <h5 class="mb-0">
<!-- 
        <button class="btn btn-link wildWidth collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
          <li id="geriatrie" class="list-group-item tiles">
          <div class="fas fa-heartbeat pictoParent"></div>&nbsp; Gériatrie</li>
        </button> -->
          <button class="btn btn-link wildWidth" data-toggle="collapse" data-target="#collapseThree"  aria-expanded="false" aria-controls="collapseThree">
           <li id="geriatrie" class="list-group-item tiles">
          <div class="rondBlanc text-center"> <embed type="image/svg+xml" class=" pictoParent" src="img/old-man-walking-with-a-crutch.svg"> </div><div class="pad">&nbsp; Gériatrie</div>
         </li>
        </button>
      </h5>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="headingfour">
                                                <h5 class="mb-0">
       <!--  <button class="btn btn-link wildWidth collapsed" data-toggle="collapse" data-target="#collapsefour" aria-expanded="false" aria-controls="collapsefour">
          <li id="maternite" class="list-group-item tiles">
          <div class="fas fa-heartbeat pictoParent"></div>&nbsp; Maternité</li>
        </button> -->
        <button class="btn btn-link wildWidth" data-toggle="collapse" data-target="#collapsefour"  aria-expanded="false" aria-controls="collapsefour">
           <li id="maternite" class="list-group-item tiles">
          <div class="rondBlanc text-center"> <embed type="image/svg+xml" class=" pictoParent" src="img/baby-with-diaper.svg"> </div><div class="pad">&nbsp; Maternité</div>
         </li>
        </button>
      </h5>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="headingfive">
                                                <h5 class="mb-0">
<!--         <button class="btn btn-link wildWidth collapsed" data-toggle="collapse" data-target="#collapsefive" aria-expanded="false" aria-controls="collapsefive">
          <li id="medecine" class="list-group-item tiles">
          <div class="fas fa-heartbeat pictoParent"></div>&nbsp; Médecine</li>
        </button> -->
          <button class="btn btn-link wildWidth" data-toggle="collapse" data-target="#collapsefive"  aria-expanded="false" aria-controls="collapsefive">
           <li id="medecine" class="list-group-item tiles">
          <div class="rondBlanc text-center"> <embed type="image/svg+xml" class=" pictoParent" src="img/doctor-stethoscope.svg"> </div><div class="pad">&nbsp; Médecine</div>
         </li>
        </button>
      </h5>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="headingsix">
                                                <h5 class="mb-0">
<!--         <button class="btn btn-link wildWidth collapsed" data-toggle="collapse" data-target="#collapsesix" aria-expanded="false" aria-controls="collapsesix">
          <li id="pediatrie" class="list-group-item tiles">
          <div class="fas fa-heartbeat pictoParent"></div>&nbsp; Pédiatrie</li>
        </button> -->
          <button class="btn btn-link wildWidth" data-toggle="collapse" data-target="#collapsesix"  aria-expanded="false" aria-controls="collapsesix">
           <li id="pediatrie" class="list-group-item tiles">
          <div class="rondBlanc text-center"> <embed type="image/svg+xml" class=" pictoParent" src="img/pediatry.svg"> </div><div class="pad">&nbsp; Pédiatrie</div>
         </li>
        </button>
      </h5>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="headingseven">
                                                <h5 class="mb-0">
<!--         <button class="btn btn-link wildWidth collapsed" data-toggle="collapse" data-target="#collapseseven" aria-expanded="false" aria-controls="collapseseven">
          <li id="psychiatrie" class="list-group-item tiles">
          <div class="fas fa-heartbeat pictoParent"></div>&nbsp; Psychiatrie</li>
        </button> -->
          <button class="btn btn-link wildWidth" data-toggle="collapse" data-target="#collapseseven"  aria-expanded="false" aria-controls="collapseseven">
           <li id="psychiatrie" class="list-group-item tiles">
          <div class="rondBlanc text-center"> <embed type="image/svg+xml" class=" pictoParent" src="img/neurology.svg"> </div><div class="pad">&nbsp; Psychiatrie</div>
         </li>
        </button>
      </h5>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="headingeight">
                                                <h5 class="mb-0">
        <button class="btn btn-link wildWidth collapsed butonHeigh" data-toggle="collapse" data-target="#collapseeight" aria-expanded="false" aria-controls="collapseeight">
          <li id="urgences" class="list-group-item tiles">
          <div class="rondBlanc text-center"> <i class="fas fa-procedures pictoParent"></i> </div>
         <div class="pad">&nbsp; SSR</div></li>
        </button>
      </h5>
                                            </div>
                                            ...
                                            <div class="card-header" id="headingnine">
                                                <h5 class="mb-0">
        <button class="btn btn-link wildWidth collapsed butonHeigh" data-toggle="collapse" data-target="#collapsenine" aria-expanded="false" aria-controls="collapsenine">
          <li id="urgences" class="list-group-item tiles">
          <div class="rondBlanc text-center"> <i class="fas fa-x-ray pictoParent"></i> </div>
         <div class="pad">&nbsp; Imagerie</div></li>
        </button>
      </h5>
                                            </div>
                                            ...
                                            <div class="card-header" id="headingten">
                                                <h5 class="mb-0">
        <button class="btn btn-link wildWidth collapsed butonHeigh" data-toggle="collapse" data-target="#collapseten" aria-expanded="false" aria-controls="collapseten">
          <li id="urgences" class="list-group-item tiles">
          <div class="rondBlanc text-center"> <i class="fas fa-plus-square pictoParent"></i> </div>
         <div class="pad">&nbsp; Autres</div></li>
        </button>
      </h5>
                                            </div>
                                            ...
                                            <div class="card-header" id="headingeleven">
                                                <h5 class="mb-0">
        <button class="btn btn-link wildWidth collapsed butonHeigh" data-toggle="collapse" data-target="#collapseeleven" aria-expanded="false" aria-controls="collapseeleven">
          <li id="urgences" class="list-group-item tiles">
          <div class="rondBlanc text-center"> <i class="fas fa-ambulance pictoParent"></i> </div>
         <div class="pad">&nbsp; Urgences</div></li>
        </button>
      </h5>
                                            </div>
